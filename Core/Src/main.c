...
/* Definitions for lcd_A */
osThreadId_t lcd_AHandle;
const osThreadAttr_t lcd_A_attributes = {
  .name = "lcd_A",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for lcd_B */
osThreadId_t lcd_BHandle;
const osThreadAttr_t lcd_B_attributes = {
  .name = "lcd_B",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/* USER CODE BEGIN Header_Start_lcd_A */
/**
* @brief Function implementing the lcd_A thread.
* @param argument: Not used
* @retval None
*/
...
void Start_lcd_A(void *argument)
{
  ...
  /* USER CODE END Start_lcd_A */
}

/* USER CODE BEGIN Header_Start_lcd_B */
/**
* @brief Function implementing the lcd_B thread.
* @param argument: Not used
* @retval None
*/
